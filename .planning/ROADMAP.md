...
- [ ] **Phase 6: Starfield Detection & CE2 Path Resolution** — Detect Starfield under Proton; resolve the CE2 `My Games/Starfield` config path (case-folded, first-launch-aware) + version-drift signal
