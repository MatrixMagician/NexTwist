...
> Ran a package-legitimacy check + crates.io registry verification.
...
- **Phase gate:** `cargo test --workspace` green (≥82 prior + new) + `cargo deny check` (GPL-3.0 allowance present)
